...
public class NodeTypeChecker {
	 ...
	 * @return in case of there is specified node type matches specified all types,
	 * it returns true.<br>
	 ...
	 * @param node target node
	 * @param types node types for checking
	 * @return in case of there is no specified node type matches specified all types,
	 * it returns true.<br>
	 * otherwise, it returns false.
	 */
